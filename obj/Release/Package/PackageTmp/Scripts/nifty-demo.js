...
$(document).ready(function() {
    ...
    if (typeof window.demoLayout === 'undefined') {
        $('#demo-toggle-mainnav-btn').on('click', function(e) {
            e.preventDefault();
            if ($.cookie('settings-nav-offcanvas')) {
                $.niftyNav($.cookie('settings-nav-offcanvas') + 'Toggle');
            } else {
                $.niftyNav('colExpToggle');
            }
        });
    ...
    $('#demo-page-alert').on('click', function(ev) {
        ...
        var dataNum = nifty.randomInt(0, 8),
            timer = function() {
                if (nifty.randomInt(0, 3) < 2) return 3500
                return 0;
            }();
    ...
    */
    ...
    /*
        // Fixed navbar
        if($.cookie('settings-navbar-fixed') == 1){
    ...
    */
    ...
    /*
        // Fixed footer
        if($.cookie('settings-footer-fixed')==1){
