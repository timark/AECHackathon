...
(function ($) {
    ...
    var Mapplic = function () {
        ...
        self.init = function (el, params) {
            ...
            if (jQuery.type(self.o.source) == "string") {
                // Process JSON file
            ...
            } else if (jQuery.type(self.o.source) == "object") {
        ...
        var processData = function (data) {
            ...
            if (data.levels) {
                $.each(data.levels, function (index, value) {
                    ...
                    // if the source is a file then test the file type 
                    ...
                    if (extension.length > 0) {
                        ...
                        // its an svg in a varaible 
                        $('<div></div>').addClass('mapplic-map-image').html(source, function () {
                            // setting up the location on the map
                            $(self.o.selector, this).each(function () {
                                var location = getLocationData($(this).attr('id'));
                                if (location) {
